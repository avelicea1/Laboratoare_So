...
#include <stdio.h>
#include <stdlib.h> // am inlocuit 1 cu l 
#define ISBITSET(number, POS) ((number)&(1 << (POS))) // am inlocuit 0 cu O 
...
int main(int argc, char **argv)
{
    ...
    sscanf(argv[1], "%d", &largest_num); // am pus & pentru a putea stoca in variabila largest_num
